...
# paths
workdir=/tmp/linden/work/${subject} # this directory is just a temp directory where intermediate outputs/files from fmriprep are dumped. It must be subject specific though!
...
# 3) this variant of the code does not run freesurfer and only outputs in T1w and template space.
